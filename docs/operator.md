...
- **Sidebar** — Quick Select bands, one **sweep range** readout (type `88-108`, pan ◀▶, zoom −/+), radio identity, **MCP** (bind and connected agents), FM tuner, TV tuner, **NFC sniff**, **BLE sniff**, Pause, then gain and display options
